...
const kk = require('../devdata/assets/edit.jpg');

const SideMenu = ({ toggleSideMenu, isMenuOpen, navigation }) => {
    ...
    <Animated.View style={{ transform: [{ translateX: slideAnim }] }}>
      <TouchableOpacity onPress={toggleSideMenu} activeOpacity={1}>
        <View style={styles.sideMenu}>
          <Text style={styles.alertTitle}>Fiyot</Text>
          ...
          <View style={styles.container}>
            ...
            >
              ...
              <Text style={styles.buttonText}>TnC</Text>
            </TouchableOpacity>
